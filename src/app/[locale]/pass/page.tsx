...
import PassStudio from "@/components/PassStudio";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}${localizedPath(locale, "pass")}`,
      languages: languageAlternates("pass"),
    },
    openGraph: {
      title: t("meta_title"),
      description: t("meta_description"),
      url: `${SITE_URL}${localizedPath(locale, "pass")}`,
    },
  };
}
